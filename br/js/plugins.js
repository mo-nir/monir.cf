...
$(document).ready(function() {
	...
	var owl = $('.testimonial-blog-carousel');
    owl.owlCarousel({
	 ...
	 var owl = $('.testimonial01-carousel');
    owl.owlCarousel({
	...
	var owl = $('.testimonials01-carousel');
    owl.owlCarousel({
    ...
    Starrr.prototype.syncRating = function(rating) {
      ...
      if (rating && rating < 5) {
        for (i = _j = rating; rating <= 4 ? _j <= 4 : _j >= 4; i = rating <= 4 ? ++_j : --_j) {
          this.$el.find('span').eq(i).removeClass('fa-star-star').addClass('fa-star-o');
        }
      }
      if (!rating) {
        return this.$el.find('span').removeClass('fa-star-star').addClass('fa-star-o');
      }
    };
